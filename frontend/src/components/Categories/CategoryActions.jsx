                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-start mb-4">
                                ...
                                <div className="ml-4 flex-1 mr-2">
                                    ...
                                    <p className="text-sm text-gray-600 leading-relaxed" style={{ fontFamily: 'Poppins, sans-serif' }}>
                                        la categoría "<span className="font-medium text-gray-900">{category.name}</span>"?
                                    </p>
                            ...
                            <div className="flex justify-end space-x-3 mt-6">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-white rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-pink-300"
                                    style={{
                                        fontFamily: 'Poppins, sans-serif',
                                        backgroundColor: '#FDB4B7',
                                        ':hover': {
                                            backgroundColor: '#fc9ca0'
                                        }
                                    }}
