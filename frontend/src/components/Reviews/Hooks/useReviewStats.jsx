...
export const useReviewStats = () => {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                setLoading(true);
                const response = await fetch('https://marquesa.onrender.com/api/reviews/stats');
    ...
    const getStatsForPeriod = async (startDate, endDate) => {
        try {
            ...
            const response = await fetch(`https://marquesa.onrender.com/api/reviews/stats/period?${params}`);
