...
import { Eye, X, Phone, MapPin, Calendar, User, Package, CreditCard, Clock } from "lucide-react";
...
const SalesCard = ({ sale, onUpdateStatus }) => {
    ...
    return (
        <>
            <div className={`rounded-xl border-2 p-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.02] ${getStatusColor(sale.trackingStatus)}`}>
                ...
                <div className="flex justify-between items-start mb-5">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`px-3 py-1.5 rounded-full text-xs font-semibold border flex items-center gap-1.5 ${getStatusBadgeColor(sale.trackingStatus)}`}>
                    ...
                    <div className="space-y-3">
                        {sale.items.map((item, index) => (
                            <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                                ...
                                <span className="text-green-600 font-semibold">${item.subtotal}</span>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <span className="font-semibold text-gray-800">{sale.receiverName}</span>
                            </div>
                        </div>
                        <div>
                        ...
                        <div className="col-span-2">
                            <span className="text-gray-500 font-medium">Punto de referencia:</span>
                            <div className="flex items-center gap-2 mt-1">
                        ...
                        <div className="col-span-2">
                            <span className="text-gray-500 font-medium">Fecha de entrega:</span>
                            <div className="flex items-center gap-2 mt-1">
                ...
                <div className="flex justify-between items-center mb-5 bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="font-semibold text-gray-800">{sale.paymentType}</div>
                        </div>
                    </div>
                    <div className="text-right">
                        <span className="text-gray-500 text-sm">Total:</span>
                        <div className="text-2xl font-bold text-green-600">${sale.total}</div>
                    </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            <span className="text-xs font-medium text-gray-600">Dirección completa:</span>
                            <p className="text-sm text-gray-800 mt-1">{sale.deliveryAddress}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {showPaymentProof && (
                <div className="fixed inset-0 bg-grey flex items-center justify-center z-50 p-4" style={{opacity: '-10px'}}>
                        ...
                        <div className="p-4">
                            <div className="mb-4">
                                <p className="text-sm text-gray-600 mb-2">
                                    <span className="font-medium">Cliente:</span> {sale.clientName}
                                </p>
                                <p className="text-sm text-gray-600 mb-2">
                                    <span className="font-medium">Método de pago:</span> {sale.paymentType}
                                </p>
                            ...
                            {sale.paymentProofImage ? (
                                <div className="text-center">
                                    ...
                                    <div className="hidden p-8 text-center">
                                        ...
                                        <p className="text-gray-600">No se pudo cargar la imagen del comprobante</p>
                                    </div>
                                </div>
                            ) : (
                                <div className="p-8 text-center">
                                    ...
                                    <p className="text-gray-600">No hay comprobante de pago disponible</p>
                                </div>
                            )}
                        </div>
                    </div>
