            ...
            {suggestions.map((suggestion, index) => {
                ...
                return (
                    <div
                        ...
                        className={`bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 ${suggestion.onClick ? 'cursor-pointer group' : ''
                            }`}
                    ...
                    >
                        {/* Icono */}
                        <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-md mx-auto mb-4 ${suggestion.onClick ? 'group-hover:scale-110 transition-transform duration-300' : ''
                                }`}
                        ...
                        {/* Título */}
                        <h3
                            className={`font-bold text-lg mb-2 text-center ${suggestion.onClick ? 'group-hover:text-gray-800 transition-colors duration-300' : ''
                                }`}
