        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button className="bg-[#BEF7FF] hover:bg-cyan-200 text-black px-4 py-2 rounded-md text-sm flex items-center gap-2" style={{cursor: 'pointer'}} onClick={handleCustomProductClick}>
