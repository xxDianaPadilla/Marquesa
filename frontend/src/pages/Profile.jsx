...
const perfil = () => {
  ...
  return (
    <>
      ...
      <div className="p-6 md:p-10 bg-white min-h-screen font-poppins max-w-7xl mx-auto">
        <div className="flex justify-between items-center border-b pb-4 mb-6">
          ...
          <Button className="hover:bg-pink-400 text-white flex items-center" style={{ backgroundColor: '#E8ACD2' }}>
          ...
          <Card className="p-6">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                <div className="flex-1 text-center rounded-xl p-4" style={{ backgroundColor: '#E8ACD2' }}>
            ...
            <div className="text-center mt-6">
              <Button style={{ backgroundColor: '#E8ACD2', cursor: 'pointer' }} className="hover:bg-pink-400 text-white w-full" onClick={handleLogout}>Cerrar sesión</Button>
            </div>
          </Card>
          ...
          <div className="md:col-span-2">
            <Card className="p-6">
              <Tabs defaultValue="pedidos">
                ...
                <div className="mt-6" >
                  <br />
                  <p className="text-3xl font-medium mb-2">Mis pedidos recientes</p>
                  ...
                  {[{
                    ...
                    <Card key={idx} className="mb-4 border border-gray-200">
                      <div className="p-4 space-y-2">
                        ...
                        <Button className="w-full hover:bg-pink-400 text-white" onClick={handleSavesClick}style={{ backgroundColor: '#E8ACD2', cursor: 'pointer'}}>
                          Detalles pedidos
                        </Button>
                      </div>
                    </Card>
